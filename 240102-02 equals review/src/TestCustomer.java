...
public class TestCustomer {
	public static void main(String[] args) {
		...
		System.out.println(c1.equalsStrict(c2));
		System.out.println(c1.equalsStrict(c3));
		
		Customer[] arr = { c1, c2, c3 };
		Scanner scan = new Scanner(System.in);
		System.out.println("고객 정보를 입력하세요. (이름, 전화번호)");
		...
		System.out.println("동일한 고객의 예약 수: " + count);
	}
}
